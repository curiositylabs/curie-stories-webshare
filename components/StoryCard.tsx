      ...
      >
        ...
        <div class="flex w-full max-w-[26rem] flex-wrap items-center justify-center gap-3">
          <a
            ...
            class="text-white cursor-pointer items-center group bg-black border border-black shadow-md min-w-[10.5rem] flex-1 px-8 py-3 rounded-md font-bold hover:bg-gray-800 transition duration-300 ease-in-out flex justify-center gap-2 text-sm leading-5 whitespace-nowrap"
          >
            Read
          </a>
          <a
            ...
            class="text-[#110056] cursor-pointer items-center group bg-white border border-[#d8cffd] shadow-md min-w-[10.5rem] flex-1 px-6 py-3 rounded-md font-bold hover:bg-[#f8f6ff] transition duration-300 ease-in-out flex justify-center gap-2 text-sm leading-5 whitespace-nowrap"
          >
